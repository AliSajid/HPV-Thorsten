---
title: "HPV Negative - 1,4,24 hours"
...
params:
  chip_type: STK
  signal_file: "kinome_data/E4-_ExporttComplete_Median_SigmBg_260907093502.txt" # Change the file name to the one you have
  saturation_file: "kinome_data/E4-_ExporttComplete_Signal_Saturation_260907093503.txt" # Change the file name to the one you have
  threshold: 2 # Change the threshold if necessary
  prefix: hpv_neg_25.13
  pairwise: FALSE
  figure_output: NULL
---
...
qc_data <- krsa_qc_steps(raw_data) |>
    mutate(
        Group = case_when(
            ...
            str_detect(SampleName, "24h") ~ "Neg24h",
            str_detect(SampleName, "4h") ~ "Neg4h",
            str_detect(SampleName, "1h") ~ "Neg1h",
        ),
...
group_labels <- c(
    ...
    Neg24h = "HPV- Samples / 6 Gy / 24 h",
    Neg4h = "HPV- Samples / 6 Gy / 4 h",
    Neg1h = "HPV- Samples / 6 Gy / 1 h"
)
