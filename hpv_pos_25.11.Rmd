---
title: "HPV Positive - 1,4,24 hours"
...
params:
  chip_type: STK
  signal_file: "kinome_data/E2-_ExporttComplete_Median_SigmBg_260907092513.txt" # Change the file name to the one you have
  saturation_file: "kinome_data/E2-_ExporttComplete_Signal_Saturation_260907092514.txt" # Change the file name to the one you have
  threshold: 2 # Change the threshold if necessary
  prefix: hpv_pos_25.11
  pairwise: FALSE
  figure_output: NULL
---
...
qc_data <- krsa_qc_steps(raw_data) |>
    mutate(
        Group = case_when(
            ...
            str_detect(SampleName, "24h") ~ "Pos24h",
            str_detect(SampleName, "4h") ~ "Pos4h",
            str_detect(SampleName, "1h") ~ "Pos1h",
        ),
...
group_labels <- c(
    ...
    Pos24h = "HPV+ Samples / 6 Gy / 24 h",
    Pos4h = "HPV+ Samples / 6 Gy / 4 h",
    Pos1h = "HPV+ Samples / 6 Gy / 1 h"
)
